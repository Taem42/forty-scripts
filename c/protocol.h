...
mol_errno       MolReader_CampaignArgs_verify                   (const mol_seg_t*, bool);
#define         MolReader_CampaignArgs_actual_field_count(s)    mol_table_actual_field_count(s)
#define         MolReader_CampaignArgs_has_extra_fields(s)      mol_table_has_extra_fields(s, 3)
#define         MolReader_CampaignArgs_get_id(s)                mol_table_slice_by_index(s, 0)
#define         MolReader_CampaignArgs_get_period(s)            mol_table_slice_by_index(s, 1)
#define         MolReader_CampaignArgs_get_deposit(s)           mol_table_slice_by_index(s, 2)
#define         MolReader_IndexVec_verify(s, c)                 mol_fixvec_verify(s, 4)
#define         MolReader_IndexVec_length(s)                    mol_fixvec_length(s)
#define         MolReader_IndexVec_get(s, i)                    mol_fixvec_slice_by_index(s, 4, i)
mol_errno       MolReader_Summary_verify                        (const mol_seg_t*, bool);
#define         MolReader_Summary_actual_field_count(s)         mol_table_actual_field_count(s)
#define         MolReader_Summary_has_extra_fields(s)           mol_table_has_extra_fields(s, 4)
#define         MolReader_Summary_get_reveals(s)                mol_table_slice_by_index(s, 0)
#define         MolReader_Summary_get_unreveals(s)              mol_table_slice_by_index(s, 1)
#define         MolReader_Summary_get_reveals_hash(s)           mol_table_slice_by_index(s, 2)
#define         MolReader_Summary_get_lock(s)                   mol_table_slice_by_index(s, 3)
...
#define         MolBuilder_CampaignArgs_init(b)                 mol_table_builder_initialize(b, 512, 3)
#define         MolBuilder_CampaignArgs_set_id(b, p, l)         mol_table_builder_add(b, 0, p, l)
#define         MolBuilder_CampaignArgs_set_period(b, p, l)     mol_table_builder_add(b, 1, p, l)
#define         MolBuilder_CampaignArgs_set_deposit(b, p, l)    mol_table_builder_add(b, 2, p, l)
mol_seg_res_t   MolBuilder_CampaignArgs_build                   (mol_builder_t);
#define         MolBuilder_CampaignArgs_clear(b)                mol_builder_discard(b)
#define         MolBuilder_IndexVec_init(b)                     mol_fixvec_builder_initialize(b, 64)
#define         MolBuilder_IndexVec_push(b, p)                  mol_fixvec_builder_push(b, p, 4)
#define         MolBuilder_IndexVec_build(b)                    mol_fixvec_builder_finalize(b)
#define         MolBuilder_IndexVec_clear(b)                    mol_builder_discard(b)
#define         MolBuilder_Summary_init(b)                      mol_table_builder_initialize(b, 512, 4)
#define         MolBuilder_Summary_set_reveals(b, p, l)         mol_table_builder_add(b, 0, p, l)
#define         MolBuilder_Summary_set_unreveals(b, p, l)       mol_table_builder_add(b, 1, p, l)
#define         MolBuilder_Summary_set_reveals_hash(b, p, l)    mol_table_builder_add(b, 2, p, l)
#define         MolBuilder_Summary_set_lock(b, p, l)            mol_table_builder_add(b, 3, p, l)
mol_seg_res_t   MolBuilder_Summary_build                        (mol_builder_t);
#define         MolBuilder_Summary_clear(b)                     mol_builder_discard(b)
...
const uint8_t MolDefault_CampaignArgs[68]                        =  {
    0x44, ____, ____, ____, 0x10, ____, ____, ____, 0x34, ____, ____, ____,
    0x3c, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____,
};
const uint8_t MolDefault_IndexVec[4]                             =  {____, ____, ____, ____};
const uint8_t MolDefault_Summary[113]                            =  {
    0x71, ____, ____, ____, 0x14, ____, ____, ____, 0x18, ____, ____, ____,
    0x1c, ____, ____, ____, 0x3c, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____, ____,
    0x35, ____, ____, ____, 0x10, ____, ____, ____, 0x30, ____, ____, ____,
...
mol_errno MolReader_CampaignArgs_verify (const mol_seg_t *input, bool compatible) {
    if (input->size < MOL_NUM_T_SIZE) {
        return MOL_ERR_HEADER;
    }
    uint8_t *ptr = input->ptr;
    ...
    offsets[field_count] = total_size;
        ...
        inner.ptr = input->ptr + offsets[0];
        inner.size = offsets[1] - offsets[0];
        errno = MolReader_OutPoint_verify(&inner, compatible);
        if (errno != MOL_OK) {
            return MOL_ERR_DATA;
        }
        inner.ptr = input->ptr + offsets[1];
...
mol_errno MolReader_Summary_verify (const mol_seg_t *input, bool compatible) {
    if (input->size < MOL_NUM_T_SIZE) {
        return MOL_ERR_HEADER;
    }
    uint8_t *ptr = input->ptr;
    ...
    offsets[field_count] = total_size;
        ...
        inner.ptr = input->ptr + offsets[0];
        inner.size = offsets[1] - offsets[0];
        errno = MolReader_IndexVec_verify(&inner, compatible);
        if (errno != MOL_OK) {
            return MOL_ERR_DATA;
        }
        inner.ptr = input->ptr + offsets[1];
...
mol_seg_res_t MolBuilder_CampaignArgs_build (mol_builder_t builder) {
    mol_seg_res_t res;
    res.errno = MOL_OK;
    mol_num_t offset = 16;
    mol_num_t len;
    ...
    if (len == 0) {
        len = 36;
        memcpy(dst, &MolDefault_OutPoint, len);
    } else {
        mol_num_t of = builder.number_ptr[0];
        memcpy(dst, src+of, len);
    }
...
mol_seg_res_t MolBuilder_Summary_build (mol_builder_t builder) {
    mol_seg_res_t res;
    res.errno = MOL_OK;
    mol_num_t offset = 20;
    mol_num_t len;
    ...
    if (len == 0) {
        len = 4;
        memcpy(dst, &MolDefault_IndexVec, len);
    } else {
        mol_num_t of = builder.number_ptr[0];
        memcpy(dst, src+of, len);
    }
